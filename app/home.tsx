...
const s=StyleSheet.create({page:{flex:1,backgroundColor:'#f7faf8'},content:{paddingHorizontal:18,paddingTop:38,paddingBottom:32,gap:9,maxWidth:700,width:'100%',alignSelf:'center'},profile:{flexDirection:'row',alignItems:'center',gap:12,backgroundColor:'#e3f2e8',padding:11,borderRadius:16},photoButton:{width:62,height:62},photo:{width:62,height:62,borderRadius:31,backgroundColor:'#d7e2da'},placeholder:{width:62,height:62,borderRadius:31,backgroundColor:'#18794e',alignItems:'center',justifyContent:'center'},initial:{color:'#fff',fontSize:27,fontWeight:'900'},editBadge:{position:'absolute',bottom:-1,right:-3,backgroundColor:'#fff',borderRadius:12,paddingHorizontal:6,paddingVertical:2,borderWidth:1,borderColor:'#c8d8cd'},editText:{fontSize:9,fontWeight:'800',color:'#18794e'},identity:{flex:1,gap:3},name:{fontSize:18,fontWeight:'900',color:'#174b34'},nip:{fontSize:12,color:'#526158'},message:{color:'#35453b',fontWeight:'600',fontSize:11},divider:{height:1,backgroundColor:'#dce8df'},admin:{backgroundColor:'#123f2c',padding:12,borderRadius:13},adminText:{color:'#fff',fontSize:14,fontWeight:'800'},menuGrid:{flexDirection:'row',flexWrap:'wrap',gap:7},menu:{width:'48.8%',minHeight:45,backgroundColor:'#fff',paddingHorizontal:10,paddingVertical:9,borderRadius:12,borderWidth:1,borderColor:'#dce8df',justifyContent:'center'},menuText:{fontSize:12,fontWeight:'700',textAlign:'center'},logout:{textAlign:'center',color:'#b42318',paddingVertical:7,fontSize:12}});
